...
const config: CoverageBriefConfig = {
  ...
  title: "A filing path, explained without the fog.",
  ...
  imageAlt: "Layered insurance filing documents connected by a precise gold path",
  signals: [
  ...
  anatomy: [
    ...
    { title: "Build the driver file", text: "Accurate driver, vehicle, household, ownership, and incident information lets the broker check eligible programs.", tag: "Underwriting" },
  ...
  detailTitle: "The driver’s record determines the route.",
  detail: [
  ...
  faqs: [
    ...
    { q: "Can Rafla file it immediately?", a: "Timing depends on complete information, carrier eligibility, payment, binding, and the carrier’s filing process. The agency can explain the next step after reviewing the file." },
  ],
};
