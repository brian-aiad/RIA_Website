...
export default function Locations() {
  ...
  return (
    <main id="main-content" className="atlas-page locations-file">
      ...
      <DossierHeader index="LA" eyebrow="Westside atlas" title="Find the desk. Open the local file." lede="Our office is on Venice Boulevard in Mar Vista, serving nearby Westside and surrounding Los Angeles communities." image="/images/atlas/westside-atlas.webp" imageAlt="Paper relief atlas of the Los Angeles Westside with gold location pins">
        <AtlasButton tone="navy" onClick={openQuoteModal}>Start before you visit</AtlasButton>
      ...
      <section className="office-record">
        <div className="atlas-container office-record__grid">
          ...
          <div className="office-record__details motion-reveal">
            <AtlasEyebrow>Office record</AtlasEyebrow>
      ...
      <section className="city-directory">
        <div className="atlas-container">
          <div className="city-directory__heading motion-reveal"><AtlasEyebrow>Nearby service areas</AtlasEyebrow><h2>A local page for each community.</h2><p>These pages describe where we work; carrier availability and policy eligibility still depend on the individual risk.</p></div>
      ...
      <section className="planning-note"><div className="atlas-container planning-note__inner motion-reveal"><span>Local context / verified</span><p>Los Angeles City Planning groups Palms, Mar Vista, Del Rey, and Playa Vista within the Palms–Mar Vista–Del Rey Community Plan area. Rafla’s 90066 office is positioned to serve that local Westside network and nearby communities.</p></div></section>
