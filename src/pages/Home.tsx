        ...
        <div className="atlas-container ria-hero__grid">
          ...
          <figure className="ria-hero__office">
            ...
            <div className="ria-hero__office-proof">
              <AtlasImage
                src="/images/brand/office-venice-thumb-v3.webp"
                srcSet="/images/brand/office-venice-thumb-v3-sm.webp 150w, /images/brand/office-venice-thumb-v3.webp 286w"
                sizes="(max-width: 620px) 75px, 90px"
                alt="Rafla Insurance Agency on Venice Boulevard"
                width="320"
                height="240"
              />
