...
const sections: PolicySection[] = [
  ...
  { title: "Third-party content", body: ["Some links open maps, reviews, carrier resources, or other services that Rafla does not control. Accessibility varies across those external services. Contact the agency if you need help finding an alternate route to information."] },
